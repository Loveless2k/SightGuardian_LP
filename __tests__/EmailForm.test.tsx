...
jest.mock('@/app/_components/EmailForm', () => ({
  EmailForm: () => (
    <form data-testid="email-form">
      <input placeholder="Tu mejor correo electrónico" />
...
describe('Landing Page', () => {
  ...
  it('renders the subheadline', () => {
    ...
    expect(screen.getByText(/Nuestra app transforma la pantalla/)).toBeInTheDocument()
  })
  ...
  it('renders the email form', () => {
    ...
    expect(screen.getByPlaceholderText('Tu mejor correo electrónico')).toBeInTheDocument()
    expect(screen.getByRole('button', { name: 'Activa la protección visual' })).toBeInTheDocument()
  })
